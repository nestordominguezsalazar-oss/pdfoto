...
import com.pdfoto.data.storage.SavedPdf
import com.pdfoto.domain.model.PdfConfig
import com.pdfoto.domain.model.Photo
import com.pdfoto.testutil.FakePdfHistoryRepository
import com.pdfoto.testutil.MainDispatcherRule
import java.io.File
...
class GenerationViewModelTest {
    ...
    private val outputFile = File("/tmp/pdfoto-test.pdf")
    ...
    private fun viewModel(
        ...
        logger = AppLogger { File("/tmp/pdfoto-test.log") },
    )
