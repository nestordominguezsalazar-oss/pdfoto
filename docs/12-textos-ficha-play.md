# 12 - Textos para la ficha de Google Play

Listos para copiar en Play Console. Respeta los límites de Google Play.
...
| Novedades (release notes) | 500 caracteres |

---

## Nombre de la app

**Español / English:** `PDFoto`

---

## Descripción corta

**Español (76 caracteres):**
```
Convierte tus fotos en PDF sin publicidad, sin conexión y con tu privacidad.
```

**English (74 characters):**
```
...
**Español:**
```
PDFoto 1.3.0 — Convierte fotos en PDF sin publicidad y sin marca de agua. Galería y cámara, vista previa de cada foto, reordenar/rotar/eliminar, tamaño de página, orientación, márgenes y calidad, guardado en Downloads, compartir e historial.
```

**English:**
```
PDFoto 1.3.0 — Turn photos into PDF with no ads and no watermark. Gallery and camera, preview each photo, reorder/rotate/delete, page size, orientation, margins and quality, save to Downloads, share and history.
```
...
- **Política de privacidad:** la URL de `privacy.html` publicada (ver `docs/11-publicacion-play.md`).
- **Etiquetas sugeridas:** PDF, fotos, escáner, documentos.

> Nota: evita afirmaciones comparativas con otras apps por su nombre y palabras clave
> repetidas; Google puede rechazar la ficha por spam. Los textos de arriba se centran en
> funciones reales.
